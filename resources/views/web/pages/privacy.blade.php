<x-layouts.web-page-card title="Polityka prywatności">
  <x-slot:top>
    <x-web.breadcrumbs :items="[\App\Helpers\BreadcrumbItem::make('Polityka prywatności')]" />
  </x-slot:top>

  <!-- Privacy policy -->
  <x-web.card-full title="Polityka prywatności">
