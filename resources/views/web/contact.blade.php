...
<x-layouts.web title="Kontakt">
  <div class="container mx-auto flex flex-col md:flex-row pt-24 pb-16 px-4 lg:px-0 gap-16">
    <x-web.contact-card :contact="$contactData" />

    <div class="bg-[var(--webPrimaryTabBackgroundColour)] text-[var(--webHeaderTextColour)] p-8 rounded-xl shadow-md max-w-full w-1/3 mx-4 lg:mx-0 ">
      <img src="{{ asset('storage/web/contact.svg') }}" alt="banner" class="w-full h-full object-cover max-h-[400px] bg-cover bg-center" />
    </div>
  </div>
