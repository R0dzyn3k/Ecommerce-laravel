      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
          <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
            ...
            <p>Jeśli to nie Ty, nie musisz podejmować żadnych dalszych działań.</p>
          </td>
        </tr>
      </table>
    </td>
      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
          <td style="padding: 0 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
            <p>
              Jeśli masz problem z kliknięciem przycisku „Zweryfikuj adres e-mail”, skopiuj i wklej poniższy adres URL do swojej przeglądarki:
